  ...
  return (
    <svg viewBox="0 0 512 512">
      ...
      <g>
        <g>
          <g>
            <path d="M490.667,469.333v-64V320V170.667V85.333v-64C490.667,9.551,481.115,0,469.333,0C457.551,0,448,9.551,448,21.333V64 h-22.403c0.7-3.447,1.07-7.014,1.07-10.667C426.667,23.887,402.779,0,373.333,0h-64C279.887,0,256,23.887,256,53.333 c0,3.653,0.37,7.22,1.07,10.667h-22.931c0.349-2.382,0.536-4.817,0.536-7.296v-6.741C234.675,22.373,212.303,0,184.713,0h-49.429 c-27.591,0-49.941,22.373-49.941,49.963v6.741c0,2.479,0.187,4.914,0.536,7.296H64V21.333C64,9.551,54.449,0,42.667,0 C30.885,0,21.333,9.551,21.333,21.333v64v85.333V320v85.333v64C9.551,469.333,0,478.885,0,490.667S9.551,512,21.333,512h469.333 c11.782,0,21.333-9.551,21.333-21.333S502.449,469.333,490.667,469.333z M64,192h384v106.667h-22.403 c0.7-3.447,1.07-7.014,1.07-10.667c0-29.446-23.887-53.333-53.333-53.333h-64C279.887,234.667,256,258.554,256,288 c0,3.653,0.37,7.22,1.07,10.667h-22.931c0.349-2.382,0.536-4.817,0.536-7.296v-6.741c0-27.59-22.373-49.963-49.963-49.963h-49.429 c-27.591,0-49.941,22.373-49.941,49.963v6.741c0,2.479,0.187,4.914,0.536,7.296H64V192z M298.667,288 c0-5.882,4.785-10.667,10.667-10.667h64c5.882,0,10.667,4.785,10.667,10.667s-4.785,10.667-10.667,10.667h-64 C303.451,298.667,298.667,293.882,298.667,288z M128.009,291.371v-6.741c0-4.035,3.258-7.296,7.275-7.296h49.429 c4.026,0,7.296,3.27,7.296,7.296v6.741c0,4.026-3.27,7.296-7.296,7.296h-49.429C131.266,298.667,128.009,295.406,128.009,291.371z M64,341.333h71.283h49.429h124.621h64H448V384H64V341.333z M298.667,53.333c0-5.882,4.785-10.667,10.667-10.667h64 c5.882,0,10.667,4.785,10.667,10.667C384,59.215,379.215,64,373.333,64h-64C303.451,64,298.667,59.215,298.667,53.333z M128.009,56.704v-6.741c0-4.035,3.258-7.296,7.275-7.296h49.429c4.026,0,7.296,3.27,7.296,7.296v6.741 c0,4.026-3.27,7.296-7.296,7.296h-49.429C131.266,64,128.009,60.739,128.009,56.704z M135.283,106.667h49.429h124.621h64H448 v42.667H64v-42.667H135.283z M64,426.667h384v42.667H64V426.667z"></path>{" "}
          </g>
        </g>
      </g>
    </svg>
...
export const DynamicBedsSVG = ({ name }: { name: BedsTypes }) => {
  switch (name) {
    case "double":
    case "king":
    case "queen":
