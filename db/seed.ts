...
// import { Amenity, BedRoom, Location, Stay, SvgIcon, User } from "./models";
// const imgUrls = [
...
//   for (let i = 0; i < 50; i++) {
//     let idx = i % (locations.length - 1);
//     let idxPlus = (i + 1) % (locations.length - 1);
//     const amenity1 = amenities[idx]._id;
//     const amenity2 = amenities[idxPlus]._id;
...
//           beds: ["double", "single"],
//           images: [imgUrls[imgIdx]],
//         });
//         bedrooms.push(bedroom);
//         console.log(`Bedroom ${j + 1} created with ID: ${bedroom._id}`);
//       } catch (error) {
//         console.error("Error creating bedroom:", error);
//       }
//     }

//     console.log("Final bedrooms array:", bedrooms);


//     try {
//       const bedroomIds = bedrooms.map((b) => b._id);
//       await Stay.create({
//         name: "John Doe",
//         type: "Apartment",
//         entireHome: true,
...
//         baths: 2,
//         hostId: new mongo.ObjectId("667d23b8d71c9238f15ac90d"),
